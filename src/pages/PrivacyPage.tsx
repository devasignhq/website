    ...
    return (
        ...
        >
            ...
            <section id="legal-grounds" className="docs-section">
                ...
                <p className="docs-paragraph">In connection with your use of the platform, We also collect and process: account and identity data (such as your GitHub username, profile, and email address); repository and source-code data, including pull requests, commits, diffs, and file contents; linked task and ticket content (such as Linear issues, their sub-issues and comments); video recordings, transcripts, and summaries (such as Loom, YouTube, or Vimeo links you provide); images, screenshots, and documents you upload; the AI-generated review output produced from the foregoing; blockchain wallet addresses and transaction details (such as Stellar addresses); billing and payment information processed by our payment processor; and usage, log, device, and analytics data.</p>
            </section>
