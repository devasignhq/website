                    ...
                    <div className="da-faq-grid">
                        ...
                        <div className="da-faq-list">
                            ...
                            <details className="da-faq">
                                ...
                                <div className="da-faq-body"><p>Any GitHub user with <em>maintain</em> or <em>admin</em> rights on the repo, and a funded DevAsign wallet. Contributors with <em>write</em> access can request a bounty, but only maintainers can lock funds.</p></div>
                            </details>
                            <details className="da-faq">
